...
// Re-export all service instances and classes from services barrel
...
// ============================================================================
// PHASE 3: Structure Building & Export (DEPLOYED ✅)
// ============================================================================

export * from './src/services/export.service';
export * from './src/services/compliance-checker.service';
export { AbstractGeneratorService } from './src/services/abstract-generator.service';
export { MethodsPopulatorService } from './src/services/methods-populator.service';
export { IrbGeneratorService } from './src/services/irb-generator.service';
