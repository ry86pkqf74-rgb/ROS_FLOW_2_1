...
### New High-Priority Tasks (Custom AI Agents + RAG, Phase Chat)
- [x] Add phase-specific agent registry with task/type metadata and routing tiers
- [x] Integrate phase chat endpoints with AI router (no direct vendor calls) and PHI gating
- [x] Implement RAG context retrieval for phase agents (vector store / local fallback)
- [x] Persist phase chat sessions/messages with agent + RAG metadata for feedback loops
- [x] Surface phase agent + context details in web UI (PhaseChatDrawer)
- [x] Add regression/unit tests for phase chat service + route wiring
