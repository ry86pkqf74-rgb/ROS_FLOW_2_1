...
import { Loader2, Home as HomeIcon, LayoutDashboard, Workflow, Shield, Settings as SettingsIcon, BookOpen, FolderKanban, Star } from "lucide-react";
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <nav className="space-y-1 px-2 py-3">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-md px-2 py-2 text-sm font-medium text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors w-full"
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/project/:projectId/compliance">
