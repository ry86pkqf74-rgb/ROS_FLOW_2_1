...
export const STAGES: Record<StageId, StageDefinition> = {
  1: {
    ...
    longDescription: 'Design comprehensive research protocols using the PICO (Population, Intervention, Comparator, Outcomes, Timeframe) framework. AI assistance helps convert natural language descriptions into structured protocols, generate research hypotheses, identify appropriate study designs, and create detailed protocol outlines ready for IRB submission.',
    icon: Lightbulb,
    category: 'discovery',
    inputSchemaRef: 'stages/stage-01-protocol-design.input.schema.json',
    outputTypes: ['pico_framework.json', 'protocol_outline.md', 'hypotheses.json', 'study_design.json'],
    requiredPermissions: ['view_research', 'create_research'],
    requiresPhiScan: false,
    optional: false,
    estimatedDuration: 45,
    recommendedModelTier: 'STANDARD',
    helpDocPath: 'docs/stages/01-protocol-design.md',
  },
  2: {
    id: 2,
