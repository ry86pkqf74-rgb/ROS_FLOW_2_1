/**
 * Artifact Collaborative Editor Component
 *
 ...
 * Use for artifact/document editing (artifactId, documentName).
 *
 * Features:
...
interface ArtifactCollaborativeEditorProps {
  artifactId: string;
  documentName: string;
  currentUser: User;
...
export function ArtifactCollaborativeEditor({
  artifactId,
  documentName,
  currentUser,
  onSave,
  className = '',
}: ArtifactCollaborativeEditorProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/v2/artifacts/${artifactId}/versions`, {
        ...
        body: JSON.stringify({
          contentJson: content,
          yjsSnapshot: Array.from(yjsSnapshot),
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleSave} disabled={saving || !connected} size="sm">
              {saving ? (
