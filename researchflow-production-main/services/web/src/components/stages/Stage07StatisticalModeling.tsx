 ...
 * 
 * Integration: Connected to StatisticalAnalysisAgent via orchestrator API
 */
...
import {
  ...
  validateStudyData,
  getAvailableTests,
  createStudyDataFromModel,
  mapModelTypeToTestType,
  type StatisticalAnalysisResponse,
  type StatisticalResult as ApiStatisticalResult,
