...
@pytest.mark.skip(reason="Stage 6 is Study Design; analysis constants live in stage_06_analysis.py (unregistered)")
class TestStage06Constants:
    """Tests for stage_06_analysis.py constants via AST parsing. Skipped: Stage 6 is now StudyDesignAgent."""
...
@pytest.mark.skip(reason="Stage 6 is Study Design; analysis module structure lives in stage_06_analysis.py (unregistered)")
class TestStage06ModuleStructure:
    """Tests for stage_06 module structure via source inspection. Skipped: Stage 6 is now StudyDesignAgent."""
