...
@router.get("/process", response_model=GuidelineProcessResponse, summary="Process guideline query")
...
@router.get("/sources", response_model=SourcesResponse, summary="List guideline sources")
...
@router.get("/fields", response_model=FieldsResponse, summary="List medical fields")
...
@router.get("/categories", response_model=CategoriesResponse, summary="List guideline categories")
...
@router.get("/cache/health", response_model=CacheHealthResponse, summary="Check guideline cache health")
...
@router.post("/cache/invalidate", response_model=CacheInvalidateResponse, summary="Invalidate guideline cache")
