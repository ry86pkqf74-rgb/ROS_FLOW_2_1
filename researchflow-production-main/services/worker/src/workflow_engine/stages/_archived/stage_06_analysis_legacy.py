"""
Stage 06: Analysis (LEGACY - archived).
...
ARCHIVED: Stage 6 is now Study Design (stage_06_study_design).
This module is kept for reference only; do not import in the main pipeline.
"""
...
# from ...registry import register_stage  # Not registered - Stage 6 is Study Design
...
# @register_stage  # Disabled: Stage 6 is Study Design
class AnalysisStage:
    """Stage 06: Analysis
