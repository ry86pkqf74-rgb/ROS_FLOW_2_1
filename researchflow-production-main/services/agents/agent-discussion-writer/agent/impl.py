"""
agent-discussion-writer: write Discussion section from outline, verifiedClaims, extractionRows, groundingPack.
...
async def _execute_section_write(inputs: Dict[str, Any], mode: str, request_id: str) -> Dict[str, Any]:
    ...
    metadata = {
        "agentId": "agent-discussion-writer",
        "projectId": "researchflow",
        "runId": request_id,
        "threadId": "thread-discussion-writer",
        "stageRange": [1, 20],
        "currentStage": 15,
    }
    ...
    try:
        ...
        logger.warning("discussion_writer_bridge_failed", error=str(type(e).__name__))
        return {
            "section_markdown": "",
            "sectionMarkdown": "",
