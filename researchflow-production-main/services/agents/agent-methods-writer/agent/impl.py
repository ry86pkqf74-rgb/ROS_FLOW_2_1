"""
agent-methods-writer: write Methods section from outline, verifiedClaims, extractionRows, groundingPack.
...
async def _execute_section_write(inputs: Dict[str, Any], mode: str, request_id: str) -> Dict[str, Any]:
    ...
    metadata = {
        "agentId": "agent-methods-writer",
        "projectId": "researchflow",
        "runId": request_id,
        "threadId": "thread-methods-writer",
        "stageRange": [1, 20],
        "currentStage": 13,
    }
    ...
    try:
        ...
        logger.warning("methods_writer_bridge_failed", error=str(type(e).__name__))
        return {
            "section_markdown": "",
            "sectionMarkdown": "",
