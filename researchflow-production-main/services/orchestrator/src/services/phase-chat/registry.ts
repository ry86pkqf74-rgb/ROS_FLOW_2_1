...
const AGENT_REGISTRY: Record<string, PhaseAgentDefinition> = {
  ...
  'results-interpretation': {
    ...
    name: 'Results Interpretation Agent (LangSmith)',
    description: 'Multi-domain research results interpretation with worker delegation for clinical, social science, behavioral, and survey research',
    modelTier: 'FRONTIER',
    phiScanRequired: false,
    maxTokens: 8192,
    taskType: 'complex_synthesis',
    knowledgeBase: 'statistical_methods',
    stageHints: ['clinical trials', 'survey analysis', 'literature context', 'methodology audit'],
  },
  'manuscript-drafting': {
...
export const STAGE_TO_AGENTS: Record<number, string[]> = {
  ...
  7: ['statistical-analysis', 'model-builder', 'results-interpretation'],
  8: ['model-builder', 'statistical-analysis', 'results-interpretation'],
  9: ['results-interpreter', 'statistical-analysis', 'results-interpretation'],
