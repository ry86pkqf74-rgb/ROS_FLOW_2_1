...
const BUILTIN_PROVIDERS: Omit<AiProvider, 'createdAt' | 'updatedAt'>[] = [
  ...
  },
  {
    ...
    description: 'Mercury general-purpose diffusion LLM for chat and reasoning',
    capabilities: ['CHAT', 'TOOLS'],
    models: [
      {
        id: 'mercury',
  ...
  {
    id: 'mercury-coder',
    displayName: 'Mercury Coder (Inception Labs)',
    description: 'Ultra-fast diffusion LLM for code: FIM, Apply-Edit, NextEdit - 5-10x faster than GPT-4o mini',
    ...
    models: [
      {
        ...
        capabilities: ['CODE', 'CHAT', 'TOOLS'],
        contextWindow: 128000, // Chat context
        maxOutputTokens: 8192,
        inputCostPer1k: 0.00025,
        outputCostPer1k: 0.001,
      },
    ...
    configSchema: {
      ...
      required: ['apiKey'],
      properties: {
        apiKey: { type: 'string', description: 'Mercury/InceptionLabs API key' },
        // Mercury Coder supports multiple endpoints:
        // - v1/chat/completions (standard chat, 128K context)
        // - v1/fim/completions (fill-in-middle, 32K context)
        // - v1/apply/completions (apply edits, 32K context)
        // - v1/edit/completions (next-edit prediction, 32K context)
      },
    },
  },
];
