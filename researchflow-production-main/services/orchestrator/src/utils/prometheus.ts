 ...
 * - ros_stage_errors_total{stage_id} - Counter for stage errors
 * - ros_stage_execution_duration_seconds{stage_id} - Histogram for stage execution duration
...
/** Counter for stage errors (failed executions), labeled by stage_id and error_kind */
export const stageErrorsTotal = new Counter(
  'ros_stage_errors_total',
  'Total stage errors by stage_id and error_kind',
  ['stage_id', 'error_kind']
);

/** Histogram for stage execution duration in seconds (alias of ros_stage_duration_seconds for clarity) */
export const stageExecutionDurationSeconds = new Histogram(
  'ros_stage_execution_duration_seconds',
