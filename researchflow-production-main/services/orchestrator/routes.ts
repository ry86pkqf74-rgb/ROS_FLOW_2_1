...
import aiStreamingRouter from "./src/routes/ai-streaming";
...
// User Favorites, FAVES compliance, and Phrases routes
import userFavoritesRouter from "./src/routes/user-favorites";
import favesRouter from "./src/routes/faves";
...
import versionControlRouter from "./src/routes/version-control";
...
const ROS_API_URL = process.env.ROS_API_URL || "http://worker:8000";
...
export async function registerRoutes(
  ...
  // Mount Chat routes (artifact-scoped chat with governance)
  ...
  // AI Streaming (SSE for AI responses)
  app.use("/api/ai", aiStreamingRouter);
